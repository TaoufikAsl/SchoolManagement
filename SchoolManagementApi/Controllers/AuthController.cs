...
namespace SchoolManagementApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(ILogger<AuthController> logger, SchoolContext context, IConfiguration configuration)
        {
            _logger = logger;
            _context = context;
        ...
        {
            _logger.LogInformation("Register attempt for user: {Username}", user.Username);
        ...
        public async Task<IActionResult> Login([FromBody] User login)
        {
            ...
            {
                _logger.LogWarning("Password verification failed for user: {Username}", login.Username);
                return Unauthorized(new { message = "Invalid username or password." });
            }
